...
$archive_column = get_theme_mod( 'kavine_blog_blog_archive_column',4); 
?>
            ...
            <header class="page-header">
                <h2 class="page-title">
	            	...
	            	if ( kavine_blog_is_latest_posts() ) {
	            		echo esc_html( get_theme_mod( 'kavine_blog_your_latest_posts_title', esc_html__( 'Blogs', 'mix-blog' ) ) ); 
...
<div id="inner-content-wrapper" class=" <?php if ($archive_column > 3) { ?>wide-wrapper <?php } ?> wrapper page-section">
	<div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
							...
							while ( $sticky_query->have_posts() ) : $sticky_query->the_post(); ?>
								<article id="post-<?php the_ID(); ?>" <?php post_class('grid-item'); ?>>
									<?php 
										...
										$archive_layout = get_theme_mod( 'kavine_blog_archive_layout', 'archive-three' );
										...
										$second_image_id = get_post_meta( get_the_ID(), '_kavine_blog_image_id', true );
										$archive_two_second_image = wp_get_attachment_image_src( $second_image_id, "kavine-blog-archive-two", "", array( "class"=> "img-responsive" ) );
								        	...
								        	<?php } elseif ((!empty($second_image) || !empty( $img_url ) ) && ($archive_layout=='archive-two' || $archive_layout=='archive-three') ){ ?>
								    			...
								    			<?php if (!empty($img_url)): ?>
									        		<div class="main-featured-image"> 
									        			<a href="<?php echo the_permalink();?>"><img src="<?php the_post_thumbnail_url( 'kavine-blog-archive-two' ); ?>"></a>
									        		</div>
								        		<?php endif ?>
									    		<?php if (!empty($second_image)): ?>
									    ...
									    <div class="shadow-entry-content">
									        <?php
												...
												if ( 'excerpt' == $archive_content_type ) {
											        ...
											        <div class="read-more-link">
													    <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_theme_mod( 'kavine_blog_archive_excerpt', esc_html__( 'View the post', 'mix-blog' ) ) ); ?></a>
													</div><!-- .read-more -->
												<?php
												} else {
													the_content( sprintf(
														wp_kses(
															...
															__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'mix-blog' ),
															array(
																'span' => array(
																	'class' => array(),
																),
													...
													wp_link_pages( array(
														'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'mix-blog' ),
														'after'  => '</div>',
													) );
												}
											?>
											<div class="entry-meta shadow-posted">
												...
												<div class="read-time">
													...
													echo '<span class="read-time-text">'. esc_html( get_theme_mod( 'kavine_blog_min_to_read', esc_html__( 'Min', 'mix-blog' ) ) ). '</span>';
													?>
												</div>
											</div>
            ...
            $blog_sidebar = get_theme_mod( 'kavine_blog_blog_sidebar', 'right' ); 
            $archive_column = get_theme_mod( 'kavine_blog_blog_archive_column',4); 
