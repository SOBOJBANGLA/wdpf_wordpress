...
function kavine_blog_popular_news() {
	register_widget( 'Kavine_Blog_Popular_Posts' );
}
add_action( 'widgets_init', 'kavine_blog_popular_news' );

class Kavine_Blog_Popular_Posts extends WP_Widget{ 
	...
	function __construct() {
		...
		parent::__construct( 'Kavine_Blog_Popular_Posts',esc_html__( 'ST: Popular Posts', 'kavine-blog' ), $widget_popular, $control_ops );
	}
