<?php 
	 ...
	 */
	function kavine_blog_sanitize_checkbox( $checked ) {
		// Boolean check.
	 ...
	 *
	 */
	function kavine_blog_sanitize_hex_color( $hex_color, $setting ) {
	 ...
	 */
	function kavine_blog_sanitize_image( $image, $setting ) {
		/*
	 ...
	 */
	function kavine_blog_sanitize_select( $input, $setting ) {
	 ...
	 * 
	 */
	function kavine_blog_sanitize_dropdown_pages( $page_id, $setting ) {
	 ...
	 * 
	 */
	function kavine_blog_sanitize_number_range( $number, $setting ) {
	 ...
	 */
	function kavine_blog_sanitize_html( $html ) {
	 ...
	 */
	function kavine_blog_sanitize_sort( $input ) {
	...
	if ( ! function_exists( 'kavine_blog_sanitize_category_list' ) ) :
	/**
	 ...
	 */
	function kavine_blog_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
