...
class Kavine_Blog_Customizer_Custom_Padding extends WP_Customize_Control {
...
class Kavine_Blog_Dropdown_Multiple_Chooser extends WP_Customize_Control{
    ...
    public function render_content(){
        ...
        ?>
            <label>
                ...
                <select class="kavine-blog-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
...
class Kavine_Blog_Range_Value_Control extends WP_Customize_Control {
  ...
  public function enqueue() {
    wp_enqueue_script( 'kavine-blog-customizer-range', get_template_directory_uri() . '/assets/js/customizer-range.js', array( 'jquery' ), rand(), true );
  }
  /**
...
class kavine_blog_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
